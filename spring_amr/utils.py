...
from spring_amr.dataset import AMRDataset, AMRLayerDataset, AMRDatasetTokenBatcherAndLoader, CurriculumAMRDatasetTokenBatcherAndLoader, CurriculumLayerDatasetTokenBatcherAndLoader
...
def instantiate_loader(
    ...
    if training_form == 'SC':
        ...
        loader = CurriculumLayerDatasetTokenBatcherAndLoader(
                dataset,
        ...
        if training_form == 'IC':
            loader = CurriculumAMRDatasetTokenBatcherAndLoader(
                dataset,
                batch_size=batch_size,
